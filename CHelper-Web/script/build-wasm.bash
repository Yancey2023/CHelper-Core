...
cmake -B cmake-build-emscripten-release -DCMAKE_BUILD_TYPE=Release -G "Unix Makefiles" -D CMAKE_TOOLCHAIN_FILE="./emsdk/upstream/emscripten/cmake/Modules/Platform/Emscripten.cmake" -G "MinGW Makefiles"
...
cmake -B cmake-build-emscripten-minsizerel -DCMAKE_BUILD_TYPE=MinSizeRel -G "Unix Makefiles" -D CMAKE_TOOLCHAIN_FILE="./emsdk/upstream/emscripten/cmake/Modules/Platform/Emscripten.cmake" -G "MinGW Makefiles"
